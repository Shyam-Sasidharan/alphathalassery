...
return array(
    ...
    'properties' => [
        'creator'        => 'SoarMorrow Solutions Pvt. Ltd.',
        'lastModifiedBy' => 'Vineeth N Krishnan',
        'title'          => 'Export Data',
        'description'    => 'Default spreadsheet export',
        'subject'        => 'Spreadsheet export',
        'keywords'       => 'soarmorrow, excel, export',
        'category'       => 'Excel',
        'manager'        => 'Vineeth N Krishnan',
        'company'        => 'SoarMorrow Solutions Pvt. Ltd.',
    ],
