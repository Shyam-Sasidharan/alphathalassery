...
@section('title','Update Course Semester')
...
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Course Semester</li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-md-12">
                <!-- form start -->
                <form role="form" action="{{ route('semester.edit', $semester->id) }}" lpformnum="1" method="post" enctype="multipart/form-data">
                    {!! csrf_field() !!}
                        ...
                        <div class="box-body">
                                ...
                                <div class="form-group {{ $errors->first('course_id') ? 'has-error' : '' }}">
                                    ...
                                    <select name="course_id" id="course_id" class="form-control select2">
                                        @foreach(\App\Models\Course::orderBy('name')->get() as $course)
                                            <option  value="{{$course->id}}" {{$course->id == $semester->course_id ? 'selected' : ''}} >{{$course->name}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-sm-6 col-md-6 col-lg-6">
                                <div class="form-group {{ $errors->first('semester') ? 'has-error' : '' }}">
                                    ...
                                    <input type="text" class="form-control" value="{{ old('semester') ?? ($semester->semester) }}" id="semester" autocomplete="off" name="semester">
                            ...
                            <div class="col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group {{ $errors->first('syllabus') ? 'has-error' : '' }}">
                                    ...
                                    <textarea rows="10"
                                           ...
                                           autocomplete="off"
                                           name="syllabus">{{ old('syllabus') ?? ($semester->syllabus) }}</textarea>
