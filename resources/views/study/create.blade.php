...
@section('title','Create Study Center')
...
@section('content')
    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-md-12">
                <!-- form start -->
                <form role="form" action="{{ route('study_centre.create') }}" lpformnum="1" method="post" enctype="multipart/form-data">
                    {!! csrf_field() !!}
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-sm-12 col-md-12 col-lg-12">
                                ...
                                <div class="form-group {{ $errors->first('location') ? 'has-error' : '' }}">
                                    ...
                                    <select name="location" class="form-control">
                                    	<option value="Study Centers in Kerala">Study Centers in Kerala </option>
                                    	<option value="Study Centers outside Kerala">Study Centers outside Kerala </option>
                                    	<option value="Study Centers outside India">Study Centers outside India </option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group {{ $errors->first('center') ? 'has-error' : '' }}">
                                    ...
                                    <input type="text" class="form-control" value="{{ old('center') }}" id="center" placeholder="Center" autocomplete="off" name="center">
                            ...
                            <div class="col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group {{ $errors->first('phone') ? 'has-error' : '' }}">
                                    ...
                                    <input type="text" class="form-control" value="{{ old('phone') }}" id="phone" placeholder="Contact No." autocomplete="off" name="phone">
