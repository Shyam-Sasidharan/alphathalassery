...
@section('content')
    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-md-12">
                <!-- form start -->
                <form role="form" action="{{ route('downloads.create') }}" lpformnum="1" method="post" enctype="multipart/form-data">
                    {!! csrf_field() !!}
                            ...
                            <div class="col-sm-6 col-md-6 col-lg-6">
                                <div class="form-group {{ $errors->first('download_category_id') ? 'has-error' : '' }}">
                                    ...
                                    <select name="download_category_id" id="download_category_id" class="form-control select2">
                                        @foreach(\App\Models\DownloadCategory::orderBy('created_at')->get() as $category)
