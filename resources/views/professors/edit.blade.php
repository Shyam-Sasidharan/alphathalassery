...
@section('title','Edit Professor Record')
...
@section('content')
    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-md-12">
                <!-- form start -->
                <form role="form" action="{{ route('professor.edit', $professor->id) }}" lpformnum="1" method="post" enctype="multipart/form-data">
                    {!! csrf_field() !!}
                    <div class="box box-success">
                        <div class="box-header with-border">
                            <h3 class="box-title">Update Professor</h3>
                          ...
                          @if ($professor && $professor->image && is_file(public_path($professor->image)))
                                <div class="col-sm-12">
                                    <div class="form-group {{ $errors->first('image') ? 'has-error' : '' }}">
                                        <img src="{{ asset($professor->image) }}" class="img-responsive center-block" width="300">
                                    </div>
                                </div>
                            @endif
                            {{--English Title--}}
                            ...
                            <div class="col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group {{ $errors->first('content') ? 'has-error' : '' }}">
                                    ...
                                    <textarea rows="10"
                                           ...
                                           placeholder="Content"
                                           autocomplete="off"
                                           name="content">{{ old('content') ?? $professor->content }}</textarea>
