...
@section('content')
    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-md-12">
                <!-- form start -->
                <form role="form" action="{{ route('publications.create') }}" lpformnum="1" method="post" enctype="multipart/form-data">
                    {!! csrf_field() !!}
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group {{ $errors->first('image') ? 'has-error' : '' }}">
                                    <label for="image">Image(Image Dimension 440 x 370)</label>
                                    <input type="file"
                                           class="form-control"
                                           id="image"
                                           placeholder="Profile"
